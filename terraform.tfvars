...
# terraform_dynamodb_access_policy_description = "Custom Service Role policy for Terraform to access DynamoDB for state locking" # Description of the custom DynamoDB access policy 
